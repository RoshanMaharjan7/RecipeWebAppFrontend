...
const RecipeCard = ({id,title, rating, recipeImage }:{id:string,title:string, rating: number, recipeImage: string}) => {
  return (
    <div className="bg-white rounded-lg flex-grow flex flex-col sm:flex-row sm:items-center p-4 border border-gray-200 shadow-md gap-4 sm:max-h-[152px] md:max-h-[178px] min-w-[294px]">
      <img src={recipeImage} alt="" className="h-[160px] sm:h-full rounded-md" />
