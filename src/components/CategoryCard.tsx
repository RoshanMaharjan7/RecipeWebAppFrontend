const CategoryCard = () => {
  return (
    <div className="max-h-[152.9px] min-w-[360px] relative bg-white flex-grow p-4 rounded-xl flex gap-4 font-righteous border border-gray-200 shadow-md overflow-hidden">
